...
/*
// [NOTA] Esta línea da un error 403 (Forbidden).
// La comento para que el resto del código funcione.
// Debes revisar tu API_KEY o API_URL para arreglarlo.
...
setTimeout(() =>{
    try{
        ...
        if(info.flightInfo.ticket_nat === 'NAC'){
            ...
            // [CORREGIDO] El error estaba aquí. Era "pricesNAT" y debe ser "pricesINT"
