...
/* --- FLIGHT CARDS --- */
// [CORREGIDO] Se quitó el .toFixed(2)
...
// [CORREGIDO] Función actualizada para formato 'es-CO' (Colombia)
// No añade el símbolo '$' para evitar duplicados con el HTML.
function formatPrice(number){
    return number.toLocaleString('es-CO', {
        maximumFractionDigits: 2, // Mantenemos 2 decimales
        minimumFractionDigits: 2, // Forzamos 2 decimales
        useGrouping: true         // Usar separadores de miles (puntos)
    });
}
